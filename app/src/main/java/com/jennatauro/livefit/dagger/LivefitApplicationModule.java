...
import com.jennatauro.livefit.ui.fragments.AllWorkoutsFragmentDialog;
import com.jennatauro.livefit.ui.fragments.DayFragment;
...
@Module(
        injects = {
                ...
                WorkoutViewPagerActivity.class,
                ExerciseViewPagerFragment.class
        },
        includes = {
                DataModule.class
        },
